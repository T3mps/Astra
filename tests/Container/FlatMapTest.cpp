...
// SwissTable-internals tests (tombstones, rehashing, group boundaries,
// collision handling, randomized differential stress) split out
// (2026-07-10 test-suite audit) into tests/Container/FlatMapInternalsTest.cpp.
